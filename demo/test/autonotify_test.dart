  ...
  group('es6 proxy strategy', () {
    ...
    group('list', () {
      ...
      test('from js',() {
        ...
        JsObject x = convertToJs(myList);
        expect(myList,new isInstanceOf<JsArrayList>(),reason:'should be a JsArrayList');
        expect(x==myList,isFalse,reason:'should not be the converted dart list');
      ...
      test('concat', () {
          ...
          print("res : ${res}");
          expect(res,new isInstanceOf<JsArrayList>(),reason:'should be a JsArrayList');
          expect(res.length,2);
          expect(res[0],'a');
